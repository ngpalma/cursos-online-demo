...
function Cart() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-10">
      <Helmet>
        <title>Cursos Online - Cart</title>
        <meta name="description" content="View your course cart." />
      </Helmet>
      ...
      {cart.length === 0 ? (
        ...
        <div className="max-w-4xl mx-auto mt-6">
          ...
          <p className="text-xl font-bold mt-4">Total: ${total.toLocaleString('es-AR')}</p>
          <Link
            to="/checkout"
            className="mt-4 inline-block bg-purple-600 text-white px-6 py-2 rounded"
          >
            Proceed to Checkout
          </Link>
        </div>
